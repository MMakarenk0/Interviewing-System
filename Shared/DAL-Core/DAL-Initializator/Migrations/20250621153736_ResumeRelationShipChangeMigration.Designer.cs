...
namespace DAL_Initializator.Migrations
{
    ...
    [Migration("20250621153736_ResumeRelationShipChangeMigration")]
    partial class ResumeRelationShipChangeMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL_Core.Entities.CandidateProfile", b =>
                {
                    ...
                    b.Property<Guid?>("ProfileResumeId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DAL_Core.Entities.CandidateProfile", b =>
                {
                    b.HasOne("DAL_Core.Entities.Resume", "ProfileResume")
                        .WithMany()
                        .HasForeignKey("ProfileResumeId")
                        .OnDelete(DeleteBehavior.SetNull);

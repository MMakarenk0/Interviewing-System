...
namespace DAL_Initializator.Migrations
{
    ...
    [Migration("20250717113401_AddInterviewerProfileAndInterviewSlotTemplateAndSlotTemplateEntryTables")]
    partial class AddInterviewerProfileAndInterviewSlotTemplateAndSlotTemplateEntryTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL_Core.Entities.InterviewSlotTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InterviewSlotTemplates");
                });

            modelBuilder.Entity("DAL_Core.Entities.InterviewerProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DAL_Core.Entities.SlotTemplateEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("InterviewSlotTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("InterviewSlotTemplateId");

                    b.ToTable("SlotTemplateEntries");
                });
            ...
            modelBuilder.Entity("DAL_Core.Entities.InterviewerProfile", b =>
                {
                    b.HasOne("DAL_Core.Entities.InterviewSlotTemplate", "SlotTemplate")
                        .WithMany("InterviewerProfiles")
            ...
            modelBuilder.Entity("DAL_Core.Entities.SlotTemplateEntry", b =>
                {
                    b.HasOne("DAL_Core.Entities.InterviewSlotTemplate", "InterviewSlotTemplate")
                        .WithMany("Entries")
                        .HasForeignKey("InterviewSlotTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InterviewSlotTemplate");
                });
            ...
            modelBuilder.Entity("DAL_Core.Entities.InterviewSlotTemplate", b =>
                {
                    ...
                    b.Navigation("InterviewerProfiles");
                });
